...
const Vehicle = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "vehicleEngineType");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "vehicleEngineType", null, null, id);
  ...
  return (
    <div>
      <ContentHeader title="Vehicle Engine Type" />
        ...
        <div className="container-fluid">
          <div className="card">
            ...
            {showModaL && (
              <AddForm
                onClose={handleModalClose}
                title="Vehicle Engine Type"
                apiEndPoint="vehicleEngineType"
