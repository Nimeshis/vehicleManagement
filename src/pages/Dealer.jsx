...
const Dealer = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "dealer");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await fetchDataFromAPI("DELETE", "dealer", { id });
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "dealer", editedData, editedData.id);
