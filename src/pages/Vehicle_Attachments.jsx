...
const Vehicle_Attachments = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "vehicleAttachment");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "vehicleAttachment", null, null, id);
  ...
  return (
    <div>
      <ContentHeader title="Vehicle Attachments" />
...
export default Vehicle_Attachments;
