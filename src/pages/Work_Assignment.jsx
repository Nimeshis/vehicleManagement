...
const Work_Assigned = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "workAssigned");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "workAssigned", null, null, id);
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "workAssigned", editedData, editedData.id);
  ...
  return (
    <div>
      <ContentHeader title="Work Assigned" />
