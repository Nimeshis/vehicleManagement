...
const Insurance_Type = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "insuranceType");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "insuranceType", null, null, id);
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "insuranceType", editedData, editedData.id);
  ...
  return (
    <div>
      <ContentHeader title="Insurance Type" />
