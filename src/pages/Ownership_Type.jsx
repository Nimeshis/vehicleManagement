...
const Ownership_Type = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "ownershipType");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "ownershipType", null, null, id);
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "ownershipType", editedData, editedData.id);
  ...
  return (
    <div>
      <ContentHeader title="Ownership Type" />
