...
const Warranty_Type = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "warrantyType");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "warrantyType", null, null, id);
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "warrantyType", editedData, editedData.id);
  ...
  return (
    <div>
      <ContentHeader title="Warranty Types" />
