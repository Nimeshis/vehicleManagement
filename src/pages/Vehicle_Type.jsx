...
const Vehicle_Type = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "vehicleType");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "vehicleType", null, null, id);
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "vehicleType", editedData, editedData.id);
  ...
  return (
    <div>
      <ContentHeader title="Vehicle_Type" />
