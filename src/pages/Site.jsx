...
const Site = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "site");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "site", null, null, id);
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "site", editedData, editedData.id);
