...
const Maker = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "maker");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await fetchDataFromAPI("DELETE", "maker", { id });
  ...
  const handleEditSubmit = async (editedData) => {
    try {
      await fetchDataFromAPI("PUT", "maker", editedData, editedData.id);
      const updatedData = await fetchDataFromAPI("GET", "maker");
