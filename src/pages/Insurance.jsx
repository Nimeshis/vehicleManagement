...
const Insurance = () => {
  ...
  const fetchData = async () => {
    try {
      const newData = await fetchDataFromAPI("GET", "insuranceCompany");
  ...
  const handleDelete = async (row) => {
    ...
    console.log(id);
    try {
      await fetchDataFromAPI("DELETE", "insuranceCompany", null, null, id);
  ...
  return (
    <div>
      <ContentHeader title="Insurance Company" />
